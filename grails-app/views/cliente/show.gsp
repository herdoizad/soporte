	...
	<body>
		...
		<div id="show-cliente" class="content scaffold-show" role="main">
			...
			<ol class="property-list cliente">
				...
				<li class="fieldcontain">
					<span id="latitud-label" class="property-label"><g:message code="cliente.latitud.label" default="Latitud" /></span>
					
						<span class="property-value" aria-labelledby="latitud-label"><g:fieldValue bean="${clienteInstance}" field="latitud"/></span>
				...
				<li class="fieldcontain">
					<span id="longitud-label" class="property-label"><g:message code="cliente.longitud.label" default="Longitud" /></span>
					
						<span class="property-value" aria-labelledby="longitud-label"><g:fieldValue bean="${clienteInstance}" field="longitud"/></span>
				...
				<li class="fieldcontain">
					<span id="propietario-label" class="property-label"><g:message code="cliente.propietario.label" default="Propietario" /></span>
					
						<span class="property-value" aria-labelledby="propietario-label"><g:fieldValue bean="${clienteInstance}" field="propietario"/></span>
				...
				<li class="fieldcontain">
					<span id="comercializador-label" class="property-label"><g:message code="cliente.comercializador.label" default="Comercializador" /></span>
					
						<span class="property-value" aria-labelledby="comercializador-label"><g:link controller="comercializador" action="show" id="${clienteInstance?.comercializador?.id}">${clienteInstance?.comercializador?.encodeAsHTML()}</g:link></span>
