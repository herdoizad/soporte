		...
		<div id="list-cliente" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="latitud" title="${message(code: 'cliente.latitud.label', default: 'Latitud')}" />
					
						<g:sortableColumn property="longitud" title="${message(code: 'cliente.longitud.label', default: 'Longitud')}" />
					
						<g:sortableColumn property="direccion" title="${message(code: 'cliente.direccion.label', default: 'Direccion')}" />
					
						<g:sortableColumn property="propietario" title="${message(code: 'cliente.propietario.label', default: 'Propietario')}" />
				...
				<g:each in="${clienteInstanceList}" status="i" var="clienteInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: clienteInstance, field: "latitud")}</td>
					
						<td>${fieldValue(bean: clienteInstance, field: "longitud")}</td>
					
						<td>${fieldValue(bean: clienteInstance, field: "direccion")}</td>
					
						<td>${fieldValue(bean: clienteInstance, field: "propietario")}</td>
