	...
	<body>
		...
		<div id="show-categoria" class="content scaffold-show" role="main">
			...
			<ol class="property-list categoria">
				...
				<li class="fieldcontain">
					<span id="codigo-label" class="property-label"><g:message code="categoria.codigo.label" default="Codigo" /></span>
					
						<span class="property-value" aria-labelledby="codigo-label"><g:fieldValue bean="${categoriaInstance}" field="codigo"/></span>
